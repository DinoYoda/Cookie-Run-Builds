...
function renderTierlist() {
    ...
    buildRoleHeader(tierlistContainer)  // you can keep this even if role is optional
    ...
    tiers.forEach((tierName, i) => {
        ...
        // Single column now, no role separation
        const column = document.createElement("div")
        column.className = "role-column"  // could rename to "tier-column" if you like
