...
function createCard(char) {
    ...
    if (currentGame.features.builds) {
        ...
        location.href = `?game=${currentGame.id}&char=${slug}`
    } else {
...
let html = `<a class="portrait" href="${link}" ${currentGame.features.builds ? "" : 'target="_blank"'}><img src="${imgSrc}" class="character-img">`
