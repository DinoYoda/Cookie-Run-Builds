    ...
    currentGame.tierlists.forEach(tierlist => {
        ...
        if(tierlist.tierlists){
            ...
            groupBtn.onclick = () => {
                ...
                // default to first sub tierlist
                currentTierlist = tierlist.tierlists[0]
            ...
            tierTabs.appendChild(groupBtn)

            // ---------------------
            // SUB TABS (only visible if group selected)
            // ---------------------
            if(currentTab === tierlist){

                const subContainer = document.createElement("div")
                subContainer.className = "sub-tabs"
                ...
                tierTabs.appendChild(subContainer)
...
function createCard(char) {
    ...
    const wikiLink = getWikiLink(char.name)
